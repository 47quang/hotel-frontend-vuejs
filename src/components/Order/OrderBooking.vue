    ...
    <el-row class="booking" :gutter="24">
      <el-col :span="16">
        ...
        <el-card>
          ...
          <el-radio label="Thanh toán sau"></el-radio>
        </el-card>
          ...
          <el-form :label-position="'top'">
            ...
            <el-form-item
              ...
              :rules="[
                ...
                { type: 'email', message: 'Vui lòng nhập đúng email của bạn', trigger: ['blur', 'change'] }
              ]"
            >
            ...
            <el-form-item
              class="booking__form-content" label="Activity time" required>
              <el-col class="booking__date-picker" :span="11">
                <el-form-item prop="startDate">
                  <el-date-picker type="date" placeholder="Ngày bắt đầu" v-model="order.orderLines.start" style="width: 100%;"></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col class="line text-center" :span="2">-</el-col>
              <el-col class="booking__date-picker" :span="11">
                <el-form-item prop="endDate">
                  <el-date-picker type="date" placeholder="Ngày kết thúc" v-model="order.orderLines.end" style="width: 100%;"></el-date-picker>
                </el-form-item>
              </el-col>
            </el-form-item>
            <el-form-item 
            ...
            >
               <el-input-number v-model="order.orderLines.quantity" type="quantity" :min="1" :max="10"></el-input-number>
            </el-form-item>
          </el-form>
          <div class="booking__confirm">
            <el-button class="booking__btn">Tiếp tục</el-button>
          </div>
        </el-card>
      </el-col>
      <el-col :span="8">
          ...
          <el-row class="booking__hotel-info" :gutter="24">
            ...
            <el-col :span="16" class="booking__hotel-details">
              ...
              <div class="booking__hotel-address">
                <span>{{this.hotel.address}}, {{this.wardById.name}}, {{this.districtById.name}}, {{this.provinceById.name}}</span>
              </div>
        ...
        <el-card class="booking__room-info booking__card">
          <div class="booking__room-details">
            <h4>Room name</h4> 
            <h4 class="booking__room-date">Date that the customer stays and leaves, how many nights they stay 
...
export default {
  ...
  computed: {
    hotel() {
      console.log('images: ', this.$store.state.hotelById.images)
